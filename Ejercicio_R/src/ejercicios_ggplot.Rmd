...
nuevos_nombres <- lapply(nuevos_nombres, gsub, pattern = "[ ]", replacement = "_")
nuevos_nombres <- unlist(lapply(nuevos_nombres, gsub, pattern = "[()]", replacement = ""))
nuevos_nombres
...
ggplot(data = datos, aes(x = year, y = warmest_minimum_temperature_f)) + 
	geom_line() +
	labs(title = "Eurasia: Year vs Warmest Minimum Temperature", x = "Year", y = "Warmest Minimum Temperature (Fahrenheit)")
